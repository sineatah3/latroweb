...
.method private connectGatt(Z)Landroid/bluetooth/BluetoothGatt;
    ...
    invoke-static {v0, v1, p1, p0, v2}, Lorg/libsdl/app/q;->a(Landroid/bluetooth/BluetoothDevice;Landroid/content/Context;ZLandroid/bluetooth/BluetoothGattCallback;I)Landroid/bluetooth/BluetoothGatt;
    ...
    invoke-static {v0, v1, p1, p0}, Lorg/libsdl/app/r;->a(Landroid/bluetooth/BluetoothDevice;Landroid/content/Context;ZLandroid/bluetooth/BluetoothGattCallback;)Landroid/bluetooth/BluetoothGatt;
...
.method private probeService(Lorg/libsdl/app/HIDDeviceBLESteamController;)Z
    ...
    invoke-static {p1}, Lorg/libsdl/app/a;->a(Landroid/bluetooth/BluetoothGatt;)Ljava/util/List;
    ...
    invoke-static {v3}, Lorg/libsdl/app/s;->a(Ljava/lang/Object;)Landroid/bluetooth/BluetoothGattService;

    move-result-object v3

    invoke-static {v3}, Lorg/libsdl/app/b;->a(Landroid/bluetooth/BluetoothGattService;)Ljava/util/UUID;
    ...
    invoke-static {v3}, Lorg/libsdl/app/c;->a(Landroid/bluetooth/BluetoothGattService;)Ljava/util/List;
    ...
    invoke-static {v2}, Lorg/libsdl/app/d;->a(Ljava/lang/Object;)Landroid/bluetooth/BluetoothGattCharacteristic;

    move-result-object v2

    invoke-static {v2}, Lorg/libsdl/app/o;->a(Landroid/bluetooth/BluetoothGattCharacteristic;)Ljava/util/UUID;
    ...
    invoke-static {v2, v3}, Lorg/libsdl/app/e;->a(Landroid/bluetooth/BluetoothGattCharacteristic;Ljava/util/UUID;)Landroid/bluetooth/BluetoothGattDescriptor;
    ...
    invoke-static {p1}, Lorg/libsdl/app/k;->a(Landroid/bluetooth/BluetoothGatt;)V
...
.method protected checkConnectionForChromebookIssue()V
    ...
    invoke-static {v0}, Lorg/libsdl/app/k;->a(Landroid/bluetooth/BluetoothGatt;)V
    ...
    invoke-static {v0}, Lorg/libsdl/app/a;->a(Landroid/bluetooth/BluetoothGatt;)Ljava/util/List;
...
.method protected getConnectionState()I
    ...
    invoke-static {v0, v1, v2}, Lorg/libsdl/app/n;->a(Landroid/bluetooth/BluetoothManager;Landroid/bluetooth/BluetoothDevice;I)I
...
.method public onCharacteristicChanged(Landroid/bluetooth/BluetoothGatt;Landroid/bluetooth/BluetoothGattCharacteristic;)V
    ...
    invoke-static {p2}, Lorg/libsdl/app/o;->a(Landroid/bluetooth/BluetoothGattCharacteristic;)Ljava/util/UUID;
    ...
    invoke-static {p2}, Lorg/libsdl/app/p;->a(Landroid/bluetooth/BluetoothGattCharacteristic;)[B
...
.method public onCharacteristicWrite(Landroid/bluetooth/BluetoothGatt;Landroid/bluetooth/BluetoothGattCharacteristic;I)V
    ...
    invoke-static/range {p2 .. p2}, Lorg/libsdl/app/o;->a(Landroid/bluetooth/BluetoothGattCharacteristic;)Ljava/util/UUID;
...
.method public onDescriptorWrite(Landroid/bluetooth/BluetoothGatt;Landroid/bluetooth/BluetoothGattDescriptor;I)V
    ...
    invoke-static {p2}, Lorg/libsdl/app/f;->a(Landroid/bluetooth/BluetoothGattDescriptor;)Landroid/bluetooth/BluetoothGattCharacteristic;
    ...
    invoke-static {p2}, Lorg/libsdl/app/g;->a(Landroid/bluetooth/BluetoothGattCharacteristic;)Landroid/bluetooth/BluetoothGattService;

    move-result-object p2

    sget-object p3, Lorg/libsdl/app/HIDDeviceBLESteamController;->reportCharacteristic:Ljava/util/UUID;

    invoke-static {p2, p3}, Lorg/libsdl/app/h;->a(Landroid/bluetooth/BluetoothGattService;Ljava/util/UUID;)Landroid/bluetooth/BluetoothGattCharacteristic;
    ...
    invoke-static {p2, p3}, Lorg/libsdl/app/i;->a(Landroid/bluetooth/BluetoothGattCharacteristic;[B)Z

    invoke-static {p1, p2}, Lorg/libsdl/app/j;->a(Landroid/bluetooth/BluetoothGatt;Landroid/bluetooth/BluetoothGattCharacteristic;)Z
...
.method public shutdown()V
    ...
    invoke-static {v0}, Lorg/libsdl/app/l;->a(Landroid/bluetooth/BluetoothGatt;)V
