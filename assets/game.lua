LOVELY_INTEGRITY = '220f8ffc9bf0607ba6b8476d3217ac948aacf736b9ac3e7d9cd8c98a8f7a0e53'
...
function Game:start_up()
    ...
    if settings then 
        ...
        if G.VERSION >= '1.0.0' and (love.system.getOS() == 'NOPE') and ((not settings_file.version) or (settings_file.version < '1.0.0')) then 
            ...
            if k == 'FASTFORWARD' then v = math.min(2, v) end
                self.SETTINGS[k] = v
            end
...
function Game:set_language()
    if not self.LANGUAGES then 
        ...
        self.FONTS = {
            ...
            {file = love.system.getOS() == "Android" and "resources/fonts/Alibaba-PuHuiTi-Bold.ttf" or "resources/fonts/NotoSansSC-Bold.ttf", render_scale = self.TILESIZE*7, TEXT_HEIGHT_SCALE = 0.7, TEXT_OFFSET = {x=0,y=-35}, FONTSCALE = 0.12, squish = 1, DESCSCALE = 1.1},
...
love.graphics.pop()
    ...
    if G.SETTINGS.Enhance.showFPS then
        love.graphics.push()
